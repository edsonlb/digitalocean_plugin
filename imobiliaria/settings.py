...
DJANGO_ROOT = os.path.dirname(os.path.abspath(PROJECT_ROOT))
...
TEMPLATE_DIRS = (
    os.path.join(PROJECT_ROOT, 'tempaltes'),
    os.path.join(DJANGO_ROOT, 'programa/tempaltes'),
