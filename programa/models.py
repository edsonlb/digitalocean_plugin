...
class Imovel(models.Model):
    ...
    def foto_fachada(self):

        foto = Fotos.objects.filter(
            Q(foto__contains='_60_1.JPG') | Q (foto__contains='_60_1.jpg'),
            id_empresa=self.id_empresa,
            id_imovel = self.id_imovel)[:1] # __contains corresponde ao LIKE do SQL
